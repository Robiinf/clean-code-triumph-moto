...
describe("ListTestDriveByMotorcycle Integration", () => {
  ...
  let listTestDriveByVehicule: ListTestDriveByVehicule;
  ...
  beforeAll(async () => {
    ...
    listTestDriveByVehicule = new ListTestDriveByVehicule(testDriveRepository);
  ...
  it("should return test drives by driver id", async () => {
    const testDrives = await listTestDriveByVehicule.execute(testMotorcycleId);
  ...
  it("should return empty array if no test drives found", async () => {
    const testDrives = await listTestDriveByVehicule.execute(
      "non-existing-vehicule-id"
    );
